...
const ConditionalLogic = ({ field, allFields, onChange, onClose }) => {
      ...
      {conditions.length > 0 ? (
          ...
          {conditions.map((condition, index) => (
            <Box
              ...
              sx={{
                ...
                alignItems:
                  config.direction === "row" ? "center" : "stretch",
                mb: config.spacing,
            ...
            >
              <FormControl
                sx={{
                  ...
                  width:
                    config.direction === "column" ? "100%" : "auto",
        ...
        <Box
          sx={{
            ...
            bgcolor: { xs: "grey.50", sm: "grey.50", md: "grey.25" },
            borderRadius: { xs: 1, sm: 2, md: 2 },
            border: { xs: "1px dashed", sm: "1px dashed", md: "1px dashed" },
